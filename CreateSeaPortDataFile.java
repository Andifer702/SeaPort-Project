...
public class CreateSeaPortDataFile {
   static int nt = 1; // number of ports
   static int nd = 1; // number of docks per port + 5 (>0)
   static int np = 5; // number of passenger ships per port
   static int nc = 5; // number of cargo ships per port
   static int nj = 10; // number of jobs per dock (>0)
   static int nn = 25; // number of persons per port + 5
   static String filename = "aSPag.txt";
...
class MyThing implements Comparable <MyThing> {
   ...
   void readSkillsFile () {
      try {
         ...
         Scanner sp = new Scanner (new File ("C:\\Users\\Andrew\\Documents\\NetBeansProjects\\SeaPort_Park\\src\\skillNames.txt"));
...
class MySeaPort extends MyThing {
   ...
   void readPortsFile () {
      try {
         ...
         Scanner sp = new Scanner (new File ("C:\\Users\\Andrew\\Documents\\NetBeansProjects\\SeaPort_Park\\src\\portNames.txt"));
...
class MyShip extends MyThing {
   ...
   void readWordsFile () {
      try {
         words = new ArrayList <> ();
         Scanner sp = new Scanner (new File ("C:\\Users\\Andrew\\Documents\\NetBeansProjects\\SeaPort_Park\\src\\shipNames.txt"));
...
class MyPerson extends MyThing {
   ...
   void readNamesFile () {
      try {
         words = new ArrayList <> ();
         Scanner sp = new Scanner (new File ("C:\\Users\\Andrew\\Documents\\NetBeansProjects\\SeaPort_Park\\src\\personNames.txt"));
         while (sp.hasNext()) words.add (sp.next());
